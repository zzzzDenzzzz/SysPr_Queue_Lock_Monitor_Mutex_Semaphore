...
public class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        StartingThreads(CreatingThreads(humans.Count, new ParameterizedThreadStart(CallNotMutex)));
        ...
        StartingThreads(CreatingThreads(humans.Count, new ParameterizedThreadStart(CallWithMutex)));
    ...
    static void CallWithMutex(object? obj)
    {
    ...
    static void CallNotMutex(object? obj)
    {
        if (obj is Queue<HumanClass> humans)
        {
            if (humans.Count > 0)
