...
public class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        StartingThreads(CreatingThreads(humans.Count, new ParameterizedThreadStart(CallNotLock)));
        ...
        StartingThreads(CreatingThreads(humans.Count, new ParameterizedThreadStart(CallWithLock)));
    ...
    static void CallWithLock(object? obj)
    {
    ...
    static void CallNotLock(object? obj)
    {
        if (obj is Queue<HumanClass> humans)
        {
            if (humans.Count > 0)
